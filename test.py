...
def _create_validation_data_loader(custom, img_path, batch_size, img_size, n_cpu):
    """
    ...
    :rtype: DataLoader
    """
    dataset = ListDataset(custom, img_path, img_size=img_size, multiscale=False, transform=DEFAULT_TRANSFORMS)
